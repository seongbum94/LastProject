					...
					<div class="card-body">
						<form role="form" method="post" action="modify.do" name="modifyForm">
							...
							<div class="form-group">
								...
								<input type="text" id="title" value="${hdiary.title }"
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="content" id="content" rows="3"
									placeholder="500자 내외로 작성하세요.">${hdiary.content }</textarea>
							</div>
							
							
							<input type="hidden" name="bno" value="${hdiary.hwno }" />
